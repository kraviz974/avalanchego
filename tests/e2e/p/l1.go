...
var _ = e2e.DescribePChain("[L1]", func() {
	ginkgo.It("creates and updates L1 validators", func() {
		e2e.ExecuteAPITest(TestCreateUpdateL1Validators)
	})
})

func TestCreateUpdateL1Validators(
	...
	var genesisPeerMessages = buffer.NewUnboundedBlockingDeque[p2pmessage.InboundMessage](1)
